...
class  Modal22 extends React.Component{
  ...
  render(){
    ...
    let link = '/details/' +this.props.cardDetail.id;
    let tags = this.props.cardDetail.arrtags ? this.props.cardDetail.arrtags.map((tagName) => <DetailsTags key={tagName} name={tagName} mini={"minis"}/>) : [];
      return(
        <div id="myModal-2" className="Modal">
          <div id="myModal-3" className="container asdx" >
            <div className="row">
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                  <div className="card-info-1">
                    <h5 className="title-1">{this.props.cardDetail.title} <i className="far fa-bookmark fa-sm"></i></h5>
                  </div>
